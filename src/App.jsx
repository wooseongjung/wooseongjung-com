...
const CREDENTIALS = [
  ...
  { label: 'High School', period: '2018–2021', title: 'IB Diploma · 41/45 (2nd of 18)', org: 'British International School of Cracow', detail: 'Moved from South Korea to Kraków at 17 to attend international school. Graduated 2nd in class in a multicultural environment.', accent: '#e8734a' },
  ...
  { label: 'Research', period: '2025–26', title: '5G Vehicular Fog Computing', org: 'Supervised by Dr. Khairi Hamdi', detail: '2,554-line C++ ns-3 simulation with 5G-LENA NR + SUMO. VFN matches CFN reliability at low-medium density with zero infrastructure cost.', accent: '#10b981' },
    ...
    <div>
      ...
      <section ref={bioRef} className="max-w-6xl mx-auto px-6 md:px-12 py-24">
        ...
        <div className="bio-reveal max-w-3xl space-y-5 text-lg leading-[1.8] text-midnight-600 dark:text-midnight-300 font-medium mb-16">
          ...
          <p>I grew up in <span className="underline decoration-gold/40 decoration-2 underline-offset-4 font-semibold text-midnight-800 dark:text-white">South Korea</span> for 18 years before moving to <span className="underline decoration-violet/40 decoration-2 underline-offset-4 font-semibold text-midnight-800 dark:text-white">Kraków, Poland</span> in 2018 to attend the British International School of Cracow. I graduated with an <span className="font-semibold text-midnight-800 dark:text-white">IB score of 41/45 (2nd out of 18)</span>, which took me to the <span className="font-semibold text-midnight-800 dark:text-white">University of Manchester</span> in 2021. Living across three countries shaped how I approach problems — curious, adaptable, and comfortable in unfamiliar territory.</p>
          <p>After two years of <span className="underline decoration-gold/40 decoration-2 underline-offset-4 font-semibold text-midnight-800 dark:text-white">military service in the Republic of Korea Air Force</span> — troubleshooting avionics on flight computers using ATE and ADTS, building an automated inventory system, and mentoring 16 recruits as room leader — I returned to Manchester to finish my degree with a focus on embedded systems, VLSI, and 5G network research.</p>
